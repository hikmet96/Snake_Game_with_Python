...
class Snake(object):
    ...
    def __init__(self, color, pos):
        ...
        self.dirnx = 0 # Direction de Snake sur x et y
        self.dirny = 1

    def move(self):
        for event in pygame.event.get(): # To leave the game
            if event.type == pygame.QUIT:
                pygame.quit()
            keys = pygame.key.get_pressed()

            for key in keys: # Verifier toutes les directions
    ...
    # Dessiner la grille de jeu (lignes horizontales et veticales)
...
def main():
    ...
    while flag:
        pygame.time.delay(50) # Vitesse de jeu
        clock.tick(10) # Snake se déplace à 10 frames/s 
        s.move() 
